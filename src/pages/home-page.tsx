    ...
    const fetchTodayMatches = async () => {
      ...
      if (data && data.length > 0) {
        ...
        if (teamError) {
          ...
          setTodayMatches(matchesWithTeams as Match[])
        }
      } else {
        setTodayMatches([])
      }
            ...
            <CardContent>
              {loading ? (
                  ...
                  {todayMatches.map((match) => (
                    <MatchCard
                      ...
                      onVoteSuccess={() => {
                        ...
                        const updatedMatches = [...todayMatches]
                        setTodayMatches(updatedMatches)
                      }}
                    />
                  ))}
                </div>
                ...
                <div className="text-center py-10">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">Check back later or view all upcoming matches.</p>
